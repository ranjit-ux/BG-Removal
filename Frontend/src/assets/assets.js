...
import header2_img from './header2.png'
import temp from './temp.png'
import bg_layer from './bg_layer.png'
import flowerWbg from './flowerWbg.jpg'
import flowerWObg from './flowerWObg.png'
import flowerWgrid from './flowerWgrid.png'
import flowerWObgHD from './flowerWObgHD.jpg'
export const assets = {
    logo,
    logo_icon,
    arrow_icon,
